...
def build_rlgym_from_config(config):
    ...
    if ob == 0:
        ...
        action_parser = Goalie.DefaultObsBuilder()
    ...
    if ss == 0:
        ...
        action_parser = Goalie.DefaultStateSetter()
    ...
    if rf == 0:
        ...
        action_parser = Goalie.DefaultRewardFunction()
    ...
    if tc == 0:
        ...
        action_parser = Goalie.DefaultTerminalConditions()
